...
cv = Canvas(root, width=1320, height=720, bg='white')
cv.grid(row=100, column=0, pady=2, sticky=W, columnspan=2)
...
def Recognize_Digit():
    ...
    for cnt in contours:
        ...
        color = (255, 0, 0)
        thickness = 2
        cv2.putText(image, data, (x, y - 10), font, fontScale, color, thickness)
